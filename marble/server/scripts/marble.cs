...
{
   %this.client.setPowerUp(%item.shapeFile);
...
{
   // Jeff: multiplayer code
   %obj.makePowerupParticles(%obj.powerUpData);

   if (%obj.powerUpData.image !$= "") {
      %obj.client.ghost.mountImage(%obj.powerUpData.image, %obj.powerUpData.imageSlot);
      %obj.client.ghost.schedule(%obj.getDataBlock().powerUpTime[%obj.powerUpData.powerUpId], "unmountImage", %obj.powerUpData.imageSlot);
      %obj.mountImage(%obj.powerUpData.image, %obj.powerUpData.imageSlot);
      %obj.schedule(%obj.getDataBlock().powerUpTime[%obj.powerUpData.powerUpId], "unmountImage", %obj.powerUpData.imageSlot);
   }

   %obj.client.setPowerUp("");
