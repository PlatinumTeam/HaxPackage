...
// Jeff: make the scale a little big different
function PathedInteriorData::onAdd(%this,%interior) {
   %scale = 1 + ($Game::PathedInteriorScale / 10000);
   %interior.setScale(%scale SPC %scale SPC %scale);
   $Game::PathedInteriorScale ++;
}
