...
{
   Canvas.pushDialog(ReceiveChatDlg); // Matt
   // Turn off any shell sounds...
   // alxStop( ... );

   // Jeff: this kills win7, and if higuy wants it, he can use it
   if ($win7sucks)
      $enableDirectInput = "1";
   activateDirectInput();
   ...
   playGameMusic();
   activatePackage(frame);
}

function PlayGui::onSleep(%this)
{
   Canvas.popDialog(ReceiveChatDlg); // Matt
