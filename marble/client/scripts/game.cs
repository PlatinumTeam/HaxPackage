...
function clientCmdGameEnd(%winner)
{
   if($playingDemo)
      return;
   ...
   if ($Server::ServerType $= "Multiplayer") {
      if (%winner)
         FinishGameText.setText("<just:center><font:Expo:50>Congratulations!\n<font:DomCasualD:32>Level Complete");
      else
         FinishGameText.setText("<just:center><font:Expo:50>Better luck next time!\n<font:DomCasualD:32>Level Complete");
      Canvas.pushDialog(FinishGameDlg);
   } else {
      reformatGameEndText();
